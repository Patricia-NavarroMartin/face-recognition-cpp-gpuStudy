...
void detect_crop(string imgpath, Mat img, string cascade_path)
{
	...
	detect_num =cascade.detectMultiScale(gray_gpu,faces,1.4,6);

	cout<<"detect_num= "<<detect_num<<endl;
	if(detect_num!=1)
	{
	...
	//Descargamos resultados de la GPU a la CPU
	Mat obj_host;
...
int main (int argc, char** argv)
{
	...
	else
	{
		...
		cout<<"Dirección del archivo:"<<path<<endl;
